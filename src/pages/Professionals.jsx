          ...
          <div className="px-4 py-8 max-w-7xl mx-auto">
            ...
            {isLoading ? (
              <div className="flex flex-col items-center justify-center py-20 bg-white rounded-2xl border border-gray-100 shadow-sm">
                ...
                <h3 className="text-xl font-bold text-gray-900 font-heading">Loading Professionals...</h3>
                <p className="text-gray-500 text-sm mt-2">Finding the best experts for your project</p>
              </div>
